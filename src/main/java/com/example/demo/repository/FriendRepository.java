...
public interface FriendRepository extends JpaRepository<Friend,Long> {
    @Query("""
    select new com.example.demo.dto.friend.FriendResponse(
        f.id,
        f.friend.id,
...
""")
    List<FriendResponse> findAllByUserSent(@Param("userId") Long userId);
...
""")
    List<FriendResponse> findAllByUserReceived(@Param("userId") Long userId);
